...
функции exit(n), передавая информацию в о коде завершения в оболочку. Командный файл 
должен вызывать эту программу и, проанализировав с помощью команды
$?, выдать сообщение о том, какое число было введено.
3. Написать командный файл, создающий указанное число файлов, пронумерованных
последовательно от 1 до N (например 1.tmp, 2.tmp, 3.tmp,4.tmp и т.д.). Число файлов,
которые необходимо создать, передаётся в аргументы командной строки. Этот же командный 
...
1. Создала программу, требуемую заданием 1 (рис. [-@fig:01]) и проверила её работу (рис. [-@fig:02], [-@fig:03] и [-@fig:04]):
...
![Программа 1.](image/01.png){#fig:01 width=40%}

![Файл input.](image/02.png){#fig:02 width=70%}

![Запуск программы.](image/03.png){#fig:03 width=70%}

![Файл output.](image/04.png){#fig:04 width=70%}

2. Создала программы, требуемые заданием 2 (рис. [-@fig:05] и [-@fig:06]) и проверила их работу (рис. [-@fig:07]):
...
![Программа 2 (.c).](image/05.png){#fig:05 width=50%}

![Программа 2 (.sh).](image/06.png){#fig:06 width=60%}

![Запуск программы.](image/07.png){#fig:07 width=50%}

3. Создала программу, требуемую заданием 3 (рис. [-@fig:08]) и проверила её работу (рис. [-@fig:09]):
...
![Программа 3.](image/08.png){#fig:08 width=60%}

![Запуск программы.](image/09.png){#fig:09 width=70%}

4. Создала программу, требуемую заданием 4 (рис. [-@fig:10]) и проверила её работу (рис. [-@fig:11] и [-@fig:12]):
...
![Запуск программы.](image/11.png){#fig:11 width=70%}

![Файл output.](image/12.png){#fig:12 width=70%}
