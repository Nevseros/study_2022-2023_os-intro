...
Создала каталог и файлы (рис. [-@fig:01]):
...
![Файл calculate.c.](image/01.png){#fig:02 width=70%}

![Файл calculate.h.](image/02.png){#fig:03 width=70%}

![Файл main.c.](image/03.png){#fig:04 width=70%}

![Makefile.](image/04.png){#fig:05 width=70%}

Выполнила компиляцию программы (рис. [-@fig:06]):

![Компиляция программы.](image/06.png){#fig:06 width=70%}

Запустила отладчик GDB (рис. [-@fig:07]):

![Запуск отладчика.](image/07.png){#fig:07 width=70%}

В отладчике с помощью команды `run` запустила программу (рис. [-@fig:08]):

![Запуск программы.](image/08.png){#fig:08 width=70%}

Добавила брейкпоинт и проверила его наличие с помощью команды `info breakpoints` (рис. [-@fig:09]):

![Проверка наличия брейкпоинта.](image/09.png){#fig:09 width=70%}

Удалила брейкпоинт с помощью команды `delete 1` (рис. [-@fig:10]):

![Удаление брейкпоинта.](image/10.png){#fig:10 width=70%}

С помощью утилиты `splint` проанализировали коды файлов `calculate.c` (рис. [-@fig:11]) и `main.c` (рис. [-@fig:12]):

![`calculate.c`.](image/11.png){#fig:11 width=70%}

![`main.c`.](image/12.png){#fig:12 width=70%}
